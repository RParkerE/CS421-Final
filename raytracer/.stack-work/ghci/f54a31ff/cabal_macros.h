...
/* package haskell-raytracer-0.1.0.0 */
#ifndef VERSION_haskell_raytracer
#define VERSION_haskell_raytracer "0.1.0.0"
#endif /* VERSION_haskell_raytracer */
#ifndef MIN_VERSION_haskell_raytracer
#define MIN_VERSION_haskell_raytracer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_raytracer */
...
#define CURRENT_PACKAGE_KEY "haskell-raytracer-0.1.0.0-AsRlJEc6YxX8WFBAq6wuHQ"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-raytracer-0.1.0.0-AsRlJEc6YxX8WFBAq6wuHQ"
